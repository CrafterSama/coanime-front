...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant: variantProp, size, asChild = false, prefix, suffix, children, color, ...props }, ref) => {
    ...
    return (
      <Comp
        className={cn(
          buttonVariants({ variant, size, className: colorClasses ? undefined : className }),
          colorClasses,
