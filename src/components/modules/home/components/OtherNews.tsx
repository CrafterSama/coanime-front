...
const OtherNews = ({ articles, loading }) => {
  return (
        ...
        <div className="flex flex-wrap gap-4 justify-center">
          {loading ? (
            fakeArray(15).map((_, index) => (
              <div
                key={index}
                className="article w-full sm:w-[300px] h-[300px] bg-slate-200 relative overflow-hidden rounded animate-pulse grid place-content-center">
                <div className="absolute skeleton w-full sm:w-[300px] h-full grid place-content-center text-orange-300">
